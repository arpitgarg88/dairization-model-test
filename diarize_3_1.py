"""pyannote/speaker-diarization-3.1 — local diarization.
...
MODEL_SLUG = "speaker-diarization-3.1"
...
def run_benchmark(
    ...
    for sample in tqdm(samples, desc="speaker-diarization-3.1"):
    ...
    # Weighted aggregate DER across all evaluated speech
    ...
    out_path = output_dir / "benchmark_speaker_diarization_3_1.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="pyannote speaker-diarization-3.1")
