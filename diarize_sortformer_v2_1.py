"""
Speaker diarization using nvidia/diar_streaming_sortformer_4spk-v2.1 (NeMo).

Model: https://huggingface.co/nvidia/diar_streaming_sortformer_4spk-v2.1
...
MODEL_SLUG = "diar-streaming-sortformer-4spk-v2.1"
BACKEND = "nemo-cpu"
BENCHMARK_RESULT = "benchmark_diar_streaming_sortformer_4spk_v2_1.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="NVIDIA Streaming Sortformer 4spk v2.1")
    ...
    if args.benchmark:
        run_benchmark(
            MODEL_ID,
            BENCHMARK_RESULT,
            tqdm_desc="diar-streaming-sortformer-4spk-v2.1",
            streaming_offline=True,
